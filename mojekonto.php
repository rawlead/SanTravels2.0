...
<!--==============================Content=================================-->
<div class="content"><div class="container_12">
        <form name="FormLogin" method="post" action="testreg.php" >
            <table border="0" width="300" align="center" class="demo-table" style="width: 100%">
                ...
                <tr>
                    <td colspan=2>
                        <input type="checkbox" name="terms"> I accept Terms and Conditions <input type="submit" name="submit" value="Zaloguj" class="btnRegister"></td>
                </tr>
            </table>
        </form>
